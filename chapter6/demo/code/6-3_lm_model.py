...
# D:/Users/Administrator/PycharmProjects/pythonStudy/chapter6/demo
netfile = '../tmp/net.model'  # 构建的神经网络模型存储路径

net = Sequential()  # 建立神经网络
net.add(Dense(10, input_dim=3), Activation('relu'))  # 添加输入层（3节点）到隐藏层（10节点）的连接
# net.add(Activation('relu'))  # 隐藏层使用relu激活函数
net.add(Dense(1, input_dim=10), Activation('sigmoid'))  # 添加隐藏层（10节点）到输出层（1节点）的连接
# net.add()  # 输出层使用sig moid激活函数
